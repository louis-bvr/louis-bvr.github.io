...
#manomètre t0
value = adc.read_adc(0, gain=2/3)  #obtenu par lecture du dossier technique
...
def countPulse(channel):
    ...
    #Récup manomètre
    value = adc.read_adc(0, gain=2/3)      # Lecture du port A0 de la carte ADC1115
