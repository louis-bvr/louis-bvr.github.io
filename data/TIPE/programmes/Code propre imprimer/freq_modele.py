...
maxP = max(YP)
minP = min(YP[XP.index(5):]) #va chercher la valeur min dans YP à partir de la valeur XP[i]=5 jusqu'à la fin de la liste
...
print("Débit cardiaque:",  round(moy,3), "L/min \n Delta préssion", round(DP, 3), "mmHg \n Pression max", round(maxP, 3) ,"mmHg \n Pression min", round(minP, 3), "mmHg \n Fréquence cardiaque", round(FC, 3), "bat/min")