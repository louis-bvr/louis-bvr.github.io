...
def visco(T, Veau, Vgly):
    #Densité
    DensGly = (1273.3-0.6121*T)/1000 			#densité volumique glycérol (g/cm3) (1 g/cm3 = 1000 kg/m3) || 1273.3 kg/m3 masse volumique glycerol ; 1 260 à 25°C
    ...
    contraction_av = 1-math.pow(3.520E-6*FractionMasse,3)+math.pow(1.027E-4*FractionMasse,2)+2.5E-2*FractionMasse-1.691E-4
